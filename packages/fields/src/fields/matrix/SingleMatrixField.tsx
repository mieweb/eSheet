...
export const SingleMatrixField = React.memo(function SingleMatrixField({
  ...
  if (isPreview) {
    return (
      <div className="singlematrix-field-preview es:text-estext es:pb-4">
        ...
        {rows.length > 0 && columns.length > 0 ? (
          <div
            className="singlematrix-field-grid es:border-t es:border-esborder es:pt-3"
            style={{
              display: 'grid',
  ...
  return (
    <div className="singlematrix-field-edit es:space-y-3">
      <div>
        <label
